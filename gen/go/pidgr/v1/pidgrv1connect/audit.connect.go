...
const (
	...
	AuditServiceName = "pidgr.v1.AuditService"
)
...
const (
	...
	// ListAuditEvents RPC.
	AuditServiceListAuditEventsProcedure = "/pidgr.v1.AuditService/ListAuditEvents"
...
func NewAuditServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuditServiceClient {
	...
	auditServiceMethods := v1.File_pidgr_v1_audit_proto.Services().ByName("AuditService").Methods()
	return &auditServiceClient{
		...
		exportAuditTrail: connect.NewClient[v1.ExportAuditTrailRequest, v1.ExportAuditTrailResponse](
			httpClient,
			baseURL+AuditServiceExportAuditTrailProcedure,
...
// ExportAuditTrail calls pidgr.v1.AuditService.ExportAuditTrail.
func (c *auditServiceClient) ExportAuditTrail(ctx context.Context, req *connect.Request[v1.ExportAuditTrailRequest]) (*connect.Response[v1.ExportAuditTrailResponse], error) {
...
func NewAuditServiceHandler(svc AuditServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	auditServiceExportAuditTrailHandler := connect.NewUnaryHandler(
		AuditServiceExportAuditTrailProcedure,
		svc.ExportAuditTrail,
		connect.WithSchema(auditServiceMethods.ByName("ExportAuditTrail")),
		connect.WithHandlerOptions(opts...),
	)
...
func (UnimplementedAuditServiceHandler) ListAuditEvents(context.Context, *connect.Request[v1.ListAuditEventsRequest]) (*connect.Response[v1.ListAuditEventsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pidgr.v1.AuditService.ListAuditEvents is not implemented"))
}
