...
*/
        pub async fn list_security_incidents(
            &mut self,
            request: impl tonic::IntoRequest<super::ListSecurityIncidentsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListSecurityIncidentsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/pidgr.v1.SecurityService/ListSecurityIncidents",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("pidgr.v1.SecurityService", "ListSecurityIncidents"),
                );
            self.inner.unary(req, path, codec).await
        }
...
*/
        pub async fn classify_incident(
            &mut self,
            request: impl tonic::IntoRequest<super::ClassifyIncidentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ClassifyIncidentResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/pidgr.v1.SecurityService/ClassifyIncident",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("pidgr.v1.SecurityService", "ClassifyIncident"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod security_service_server {
 ...
 Auth: Requires JWT. Staff/super-admin only.
*/
        async fn list_security_incidents(
            &self,
            request: tonic::Request<super::ListSecurityIncidentsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListSecurityIncidentsResponse>,
            tonic::Status,
        >;
 ...
 Auth: Requires JWT. Staff/super-admin only.
*/
        async fn classify_incident(
            &self,
            request: tonic::Request<super::ClassifyIncidentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ClassifyIncidentResponse>,
            tonic::Status,
        >;
...
*/
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/pidgr.v1.SecurityService/ListSecurityIncidents" => {
                    #[allow(non_camel_case_types)]
                    struct ListSecurityIncidentsSvc<T: SecurityService>(pub Arc<T>);
                    impl<
                        T: SecurityService,
                    > tonic::server::UnaryService<super::ListSecurityIncidentsRequest>
                    for ListSecurityIncidentsSvc<T> {
                        type Response = super::ListSecurityIncidentsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityService>::list_security_incidents(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListSecurityIncidentsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/pidgr.v1.SecurityService/ClassifyIncident" => {
                    #[allow(non_camel_case_types)]
                    struct ClassifyIncidentSvc<T: SecurityService>(pub Arc<T>);
                    impl<
                        T: SecurityService,
                    > tonic::server::UnaryService<super::ClassifyIncidentRequest>
                    for ClassifyIncidentSvc<T> {
                        type Response = super::ClassifyIncidentResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityService>::classify_incident(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ClassifyIncidentSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "pidgr.v1.SecurityService";
