...
/// Generated client implementations.
pub mod channel_events_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
...
*/
    #[derive(Debug, Clone)]
    pub struct ChannelEventsServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl ChannelEventsServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> ChannelEventsServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> ChannelEventsServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            ChannelEventsServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
 ...
 not as an error).
*/
        pub async fn record_channel_event(
            &mut self,
            request: impl tonic::IntoRequest<super::RecordChannelEventRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RecordChannelEventResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/pidgr.v1.ChannelEventsService/RecordChannelEvent",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "pidgr.v1.ChannelEventsService",
                        "RecordChannelEvent",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
*/
        pub async fn record_channel_event_batch(
            &mut self,
            request: impl tonic::IntoRequest<super::RecordChannelEventBatchRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RecordChannelEventBatchResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/pidgr.v1.ChannelEventsService/RecordChannelEventBatch",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
/// Generated server implementations.
pub mod channel_events_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with ChannelEventsServiceServer.
    #[async_trait]
    pub trait ChannelEventsService: std::marker::Send + std::marker::Sync + 'static {
        /** Record a single channel event. Returns accepted=false reason="duplicate"
 when the partial unique index rejects (caller treats as already-recorded,
 not as an error).
*/
        async fn record_channel_event(
            &self,
            request: tonic::Request<super::RecordChannelEventRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RecordChannelEventResponse>,
            tonic::Status,
        >;
 ...
 batched delivery report). Best-effort per-row.
*/
        async fn record_channel_event_batch(
            &self,
            request: tonic::Request<super::RecordChannelEventBatchRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RecordChannelEventBatchResponse>,
            tonic::Status,
        >;
...
*/
    #[derive(Debug)]
    pub struct ChannelEventsServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> ChannelEventsServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    for ChannelEventsServiceServer<T>
    where
        T: ChannelEventsService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::Body>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/pidgr.v1.ChannelEventsService/RecordChannelEvent" => {
                    #[allow(non_camel_case_types)]
                    struct RecordChannelEventSvc<T: ChannelEventsService>(pub Arc<T>);
                    impl<
                        T: ChannelEventsService,
                    > tonic::server::UnaryService<super::RecordChannelEventRequest>
                    for RecordChannelEventSvc<T> {
                        type Response = super::RecordChannelEventResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ChannelEventsService>::record_channel_event(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RecordChannelEventSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/pidgr.v1.ChannelEventsService/RecordChannelEventBatch" => {
                    #[allow(non_camel_case_types)]
                    struct RecordChannelEventBatchSvc<T: ChannelEventsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: ChannelEventsService,
                    > tonic::server::UnaryService<super::RecordChannelEventBatchRequest>
                    for RecordChannelEventBatchSvc<T> {
                        type Response = super::RecordChannelEventBatchResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            request: tonic::Request<
                                super::RecordChannelEventBatchRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ChannelEventsService>::record_channel_event_batch(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RecordChannelEventBatchSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for ChannelEventsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "pidgr.v1.ChannelEventsService";
    impl<T> tonic::server::NamedService for ChannelEventsServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
*/
        pub async fn trigger_archetype_clustering(
            &mut self,
            request: impl tonic::IntoRequest<super::TriggerArchetypeClusteringRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/pidgr.v1.InsightsService/TriggerArchetypeClustering",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/pidgr.v1.InsightsService/TriggerArchetypeClustering" => {
                    #[allow(non_camel_case_types)]
                    struct TriggerArchetypeClusteringSvc<T: InsightsService>(pub Arc<T>);
                    impl<
                        T: InsightsService,
                    > tonic::server::UnaryService<
                        super::TriggerArchetypeClusteringRequest,
                    > for TriggerArchetypeClusteringSvc<T> {
                        type Response = super::TriggerArchetypeClusteringResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InsightsService>::trigger_archetype_clustering(
                                        &inner,
                                        request,
                                    )
                                    .await
...
/// Generated client implementations.
pub mod integrations_internal_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
...
*/
    #[derive(Debug, Clone)]
    pub struct IntegrationsInternalServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl IntegrationsInternalServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> IntegrationsInternalServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> IntegrationsInternalServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            IntegrationsInternalServiceClient::new(
...
*/
        pub async fn purge_org(
            &mut self,
            request: impl tonic::IntoRequest<super::PurgeOrgRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PurgeOrgResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/pidgr.v1.IntegrationsInternalService/PurgeOrg",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("pidgr.v1.IntegrationsInternalService", "PurgeOrg"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
/// Generated server implementations.
pub mod integrations_internal_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with IntegrationsInternalServiceServer.
    #[async_trait]
    pub trait IntegrationsInternalService: std::marker::Send + std::marker::Sync + 'static {
        /** Purge ALL of an org's integrations data (reachability registry, channel
 dispatches, cost-cap state, region policy). Invoked only by pidgr-api's
 staff `ForceDeleteOrg` during an org wipe. Idempotent: purging an org with
 no remaining data succeeds and returns zero counts. Internal-mTLS only.
*/
        async fn purge_org(
            &self,
            request: tonic::Request<super::PurgeOrgRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PurgeOrgResponse>,
            tonic::Status,
        >;
...
*/
    #[derive(Debug)]
    pub struct IntegrationsInternalServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> IntegrationsInternalServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>>
    for IntegrationsInternalServiceServer<T>
    where
        T: IntegrationsInternalService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::Body>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/pidgr.v1.IntegrationsInternalService/PurgeOrg" => {
                    #[allow(non_camel_case_types)]
                    struct PurgeOrgSvc<T: IntegrationsInternalService>(pub Arc<T>);
                    impl<
                        T: IntegrationsInternalService,
                    > tonic::server::UnaryService<super::PurgeOrgRequest>
                    for PurgeOrgSvc<T> {
                        type Response = super::PurgeOrgResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as IntegrationsInternalService>::purge_org(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    impl<T> Clone for IntegrationsInternalServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "pidgr.v1.IntegrationsInternalService";
    impl<T> tonic::server::NamedService for IntegrationsInternalServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
*/
 ...
 composition).
*/
        pub async fn sign_deeplink_token(
            &mut self,
            request: impl tonic::IntoRequest<super::SignDeeplinkTokenRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SignDeeplinkTokenResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/pidgr.v1.TokenService/SignDeeplinkToken",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("pidgr.v1.TokenService", "SignDeeplinkToken"));
            self.inner.unary(req, path, codec).await
        }
...
*/
        pub async fn validate_deeplink_token(
            &mut self,
            request: impl tonic::IntoRequest<super::ValidateDeeplinkTokenRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ValidateDeeplinkTokenResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/pidgr.v1.TokenService/ValidateDeeplinkToken",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("pidgr.v1.TokenService", "ValidateDeeplinkToken"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod token_service_server {
 ...
 composition).
*/
        async fn sign_deeplink_token(
            &self,
            request: tonic::Request<super::SignDeeplinkTokenRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SignDeeplinkTokenResponse>,
            tonic::Status,
        >;
 ...
 token IS the lookup key; valid responses carry the decoded payload.
*/
        async fn validate_deeplink_token(
            &self,
            request: tonic::Request<super::ValidateDeeplinkTokenRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ValidateDeeplinkTokenResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/pidgr.v1.TokenService/SignDeeplinkToken" => {
                    #[allow(non_camel_case_types)]
                    struct SignDeeplinkTokenSvc<T: TokenService>(pub Arc<T>);
                    impl<
                        T: TokenService,
                    > tonic::server::UnaryService<super::SignDeeplinkTokenRequest>
                    for SignDeeplinkTokenSvc<T> {
                        type Response = super::SignDeeplinkTokenResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TokenService>::sign_deeplink_token(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SignDeeplinkTokenSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/pidgr.v1.TokenService/ValidateDeeplinkToken" => {
                    #[allow(non_camel_case_types)]
                    struct ValidateDeeplinkTokenSvc<T: TokenService>(pub Arc<T>);
                    impl<
                        T: TokenService,
                    > tonic::server::UnaryService<super::ValidateDeeplinkTokenRequest>
                    for ValidateDeeplinkTokenSvc<T> {
                        type Response = super::ValidateDeeplinkTokenResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TokenService>::validate_deeplink_token(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ValidateDeeplinkTokenSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
