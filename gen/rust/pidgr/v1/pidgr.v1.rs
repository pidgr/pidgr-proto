...
pub struct EscalateConfig {
    ...
    #[prost(enumeration="EscalateMode", tag="5")]
    pub mode: i32,
    ...
    #[prost(enumeration="ChannelName", repeated, tag="6")]
    pub third_party_channels: ::prost::alloc::vec::Vec<i32>,
}
// ─── Status Enums ───────────────────────────────────────────────────────────
...
impl EscalateMode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "ESCALATE_MODE_UNSPECIFIED",
            Self::Deliver => "ESCALATE_MODE_DELIVER",
            Self::AlertOnly => "ESCALATE_MODE_ALERT_ONLY",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "ESCALATE_MODE_UNSPECIFIED" => Some(Self::Unspecified),
            "ESCALATE_MODE_DELIVER" => Some(Self::Deliver),
            "ESCALATE_MODE_ALERT_ONLY" => Some(Self::AlertOnly),
            _ => None,
        }
    }
}
...
pub struct Delivery {
    ...
    #[prost(enumeration="delivery::Kind", tag="12")]
    pub kind: i32,
    ...
    impl Kind {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::Primary => "KIND_PRIMARY",
                Self::Escalation => "KIND_ESCALATION",
                Self::ReminderFyi => "KIND_REMINDER_FYI",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "KIND_PRIMARY" => Some(Self::Primary),
                "KIND_ESCALATION" => Some(Self::Escalation),
                "KIND_REMINDER_FYI" => Some(Self::ReminderFyi),
                _ => None,
            }
        }
    }
