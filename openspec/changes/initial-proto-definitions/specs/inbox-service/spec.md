...
The system SHALL define an InboxService in `pidgr/v1/inbox.proto` with RPCs: Sync, MarkRead.

#### Scenario: Service definition exists
- **WHEN** the proto file is compiled
- **THEN** it SHALL produce a valid InboxService with Sync and MarkRead RPCs
