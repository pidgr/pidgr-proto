...
| source | [ArchetypeSource](#pidgr-v1-ArchetypeSource) |  | Where this archetype came from. UNSPECIFIED on responses from pre-v0.79 servers; clients SHOULD treat UNSPECIFIED as ML for backward compatibility (provisional output is always labelled). |
